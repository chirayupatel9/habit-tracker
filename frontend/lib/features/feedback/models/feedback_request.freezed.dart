...
abstract class $FeedbackRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({int rating, String message});
}
...
class _$FeedbackRequestImpl implements _FeedbackRequest {
  const _$FeedbackRequestImpl({required this.rating, required this.message});
...
// 1-5
  ...
  @override
  String toString() {
    return 'FeedbackRequest(rating: $rating, message: $message)';
  }
...
abstract class _FeedbackRequest implements FeedbackRequest {
  const factory _FeedbackRequest(
      ...
      required final String message}) = _$FeedbackRequestImpl;
