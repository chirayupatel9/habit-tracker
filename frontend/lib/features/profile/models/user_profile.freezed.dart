...
abstract class $UserProfileCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String email, @JsonKey(name: 'created_at') String createdAt});
}
...
class _$UpdateProfileRequestImpl implements _UpdateProfileRequest {
  const _$UpdateProfileRequestImpl({required this.email});
  ...
  @override
  String toString() {
    return 'UpdateProfileRequest(email: $email)';
  }
...
abstract class _UpdateProfileRequest implements UpdateProfileRequest {
  const factory _UpdateProfileRequest({required final String email}) =
...
class _$DeleteAccountRequestImpl implements _DeleteAccountRequest {
  const _$DeleteAccountRequestImpl({required this.password});
...
abstract class _DeleteAccountRequest implements DeleteAccountRequest {
  const factory _DeleteAccountRequest({required final String password}) =
