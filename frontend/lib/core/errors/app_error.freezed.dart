...
mixin _$AppError {
  ...
  TResult maybeWhen<TResult extends Object?>({
    TResult Function(String message)? network,
    TResult Function(String message)? unauthorized,
    TResult Function(String message, Map<String, dynamic>? details)? validation,
    TResult Function(String message)? notFound,
    TResult Function(String message)? server,
    TResult Function(String message)? unknown,
...
class _$ValidationErrorImpl extends ValidationError {
  const _$ValidationErrorImpl(
      {required this.message, final Map<String, dynamic>? details})
      : _details = details,
        super._();
...
class _$UnknownErrorImpl extends UnknownError {
  const _$UnknownErrorImpl({required this.message}) : super._();
