...
// Add these icons for authentication UI

// AccountCircle icon for user profile
export function AccountCircle({ className = '', fontSize }: IconProps) {
  const size = getSize(fontSize);
  return (
    <svg 
      className={className} 
...
// Logout icon
export function Logout({ className = '', fontSize }: IconProps) {
  const size = getSize(fontSize);
  return (
    <svg 
      className={className} 
